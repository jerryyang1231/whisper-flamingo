...
# python -u 0821.py config/audio/a_10_t_300.yaml
...
class WhisperModelModule(LightningModule):
    def __init__(self, cfg, model_name, lang, train_split, val_split, test_split) -> None:
        super().__init__()
        self.model_name = model_name
    ...
    def val_dataloader_clean(self):
        dataset = LibriSpeechDataset(self.val_split, 
                                      self.tokenizer, 
                                      SAMPLE_RATE,
                                      self.model_name,
                                      max_length=None,
    ...
    def test_dataloader_clean(self):
        dataset = LibriSpeechDataset(self.test_split, 
                                      self.tokenizer, 
                                      SAMPLE_RATE,
                                      self.model_name,
                                      max_length=None,
...
#            config=cfg,
#            name="whisper finetune on librispeech backup",
#         #    name="whisper finetune librispeech load data(from hugging face) adjust hparams resume training",
#         #    resume="allow",
#         #    id="ry71w791"
# )
