...
# my command
# python -u whisper_ft_seediq.py config/audio/seediq.yaml
...
wandb.init(project="whisper-flamingo",
            ...
            # name="whisper_finetune_seediq_tgdaya"
            # name="whisper_finetune_seediq_truku"
            name="whisper_finetune_seediq_toda"
)
