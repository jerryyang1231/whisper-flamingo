...
# my command
# python -u whisbert_flamingo_taigi_ft_decoder.py config/audio-text/at_taigi_small_ft_decoder.yaml
...
if __name__ == "__main__":
    ...
    wandb.init(project="whisper-flamingo",
            config=cfg,
            name="whisbert-flamingo taigi small ft decoder (lr=1.0e-6)",
    )
