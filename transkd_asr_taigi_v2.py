...
# os.environ["TMPDIR"] = "/share/nas169/jerryyang/TransKD-ASR/tmp"
from transformers import BertModel, BertTokenizer
import copy
import torch.nn.functional as F

# my command
# python -u transkd_asr_taigi_v2.py config/distil/transkd_asr_taigi_v2.yaml
...
class DistillWhisperModule(LightningModule):
    ...
    def training_step(self, batch, batch_id):
        ...
        with torch.no_grad():
            ...
            teacher_out = self.teacher.decoder(dec_input_ids, teacher_feat, xt_list=[translation_embeddings])
