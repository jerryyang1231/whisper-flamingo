...
# my command
# python -u transkd-asr_librispeech.py config/distil/distil-monolingual.yaml
# python -u transkd-asr_librispeech.py config/distil/distil-monolingual_deu.yaml
# python -u transkd-asr_librispeech.py config/distil/distil-monolingual_fra.yaml
# python -u transkd-asr_librispeech.py config/distil/distil-monolingual_ita.yaml
# python -u transkd-asr_librispeech.py config/distil/distil-bilingual.yaml
# python -u transkd-asr_librispeech.py config/distil/distil-bilingual_top2.yaml
# python -u transkd-asr_librispeech.py config/distil/distil-trilingual.yaml
# python -u transkd-asr_librispeech.py config/distil/distil-quadrilingual.yaml
