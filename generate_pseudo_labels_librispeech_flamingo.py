...
# my command
# python generate_pseudo_labels_librispeech_flamingo.py config/generate_pseudo_labels_librispeech_flamingo.yaml train.clean.100+train.clean.360+train.other.500
# python generate_pseudo_labels_librispeech_flamingo.py config/generate_pseudo_labels_librispeech_flamingo.yaml test.clean
