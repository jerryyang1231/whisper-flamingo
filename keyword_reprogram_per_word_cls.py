...
# my command
# python -u keyword_reprogram_per_word_cls.py config/audio-text/at_taigi_small_keyword_reprogram_m2.yaml
# python -u keyword_reprogram_per_word_cls.py config/audio-text/at_taigi_small_keyword_reprogram_m2_keyword_only.yaml
# python -u keyword_reprogram_per_word_cls.py config/audio-text/at_taigi_small_keyword_reprogram_m2_translation_only.yaml
...
if __name__ == "__main__":
    ...
    wandb.init(project="whisper-flamingo",
            ...
            # name="whisbert-flamingo taigi small keyword (reprogram per word cls keyword only)"
            name="whisbert-flamingo taigi small keyword (reprogram per word cls translation only)"
    )
