...
# my command
# python -u trans_asr_librispeech.py config/audio-text/monolingual.yaml
# python -u trans_asr_librispeech.py config/audio-text/monolingual_deu.yaml
# python -u trans_asr_librispeech.py config/audio-text/monolingual_fra.yaml
# python -u trans_asr_librispeech.py config/audio-text/monolingual_ita.yaml
# python -u trans_asr_librispeech.py config/audio-text/monolingual_jpn.yaml
# python -u trans_asr_librispeech.py config/audio-text/monolingual_kor.yaml
# python -u trans_asr_librispeech.py config/audio-text/bilingual.yaml
# python -u trans_asr_librispeech.py config/audio-text/bilingual_top2.yaml
# python -u trans_asr_librispeech.py config/audio-text/trilingual.yaml
# python -u trans_asr_librispeech.py config/audio-text/trilingual_top3.yaml
# python -u trans_asr_librispeech.py config/audio-text/quadrilingual.yaml
# python -u trans_asr_librispeech.py config/audio-text/pentalingual.yaml
...
class LibriSpeechTextDataset(Dataset):
    def __init__(self, hf_split, tokenizer, sample_rate, model_name, max_length, 
        ...
        self.dataset = load_dataset("librispeech_asr", split=hf_split, trust_remote_code=True)
