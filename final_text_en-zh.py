...
# my command
# CUDA_VISIBLE_DEVICES=0 python -u final_text_en-zh.py config/audio-text/final_text_en-zh_last_ckpt.yaml
# python -u final_text_en-zh.py config/audio-text/final_text_en-zh_best_ckpt.yaml
...
if __name__ == "__main__":
    ...
    wandb.init(project="whisper-flamingo",
            config=cfg,
            name="whisper-flamingo en-zh (debug)",
    )
