...
# my command
# python -u translation_prompt_librispeech.py config/audio-text/translation_prompt_librispeech.yaml
...
class WhisperTextModule(LightningModule):
    ...
    def training_step(self, batch, batch_id):
        ...
        out = self.model.decoder(dec_input_ids, features)
    ...
    def validation_step(self, batch, batch_id, dataloader_idx=None):
        ...
        out_at = self.model.decoder(dec_input_ids, features_a)
...
if __name__ == "__main__":
    ...
    wandb.init(project="whisper-flamingo",
            config=cfg,
            name="translation prompt librispeech (lr=1.0e-6)",
    )
