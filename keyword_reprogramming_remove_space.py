...
# my command
# python -u keyword_reprogramming_remove_space.py config/audio-text/at_taigi_small_keyword_reprogram_m1.yaml
...
class WhisperTextModule(LightningModule):
    ...
    def training_step(self, batch, batch_id):
        ...
        # 獲取中文 BERT 的詞嵌入矩陣
        source_embedding = self.bert_model.embeddings.word_embeddings.weight.detach()  # [vocab_size, bert_hidden_size]
        value_embedding = self.bert_model.embeddings.word_embeddings.weight.detach()  # [vocab_size, bert_hidden_size]
...
if __name__ == "__main__":
    ...
    wandb.init(project="whisper-flamingo",
            config=cfg,
            # name="whisbert-flamingo taigi small keyword (reprogram)",
            name="whisbert-flamingo taigi small keyword (reprogram)(remove space)",
    )
