...
# my command
# python -u keyword_reprogramming_per_word_mean_pooling.py config/audio-text/at_taigi_small_keyword_reprogram_m2.yaml
        ...
        for mandarin_words in mandarin_words_list:
            if mandarin_words:
                ...
                bert_inputs_1 = self.bert_tokenizer(
                    ...
                    # add_special_tokens=True, # 如果要用cls embedding
                    return_tensors='pt',
                    padding=True,
                    truncation=True
                ).to(self.device)
                ...
                # 取cls當embedding
                # cls_embeddings = bert_outputs.last_hidden_state[:, 0, :]  # [num_words, hidden_size]
