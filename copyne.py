...
class YTTDTaigiTRSDataset(Dataset):
    ...
    def __getitem__(self, id):
        ...
        # 原始音檔轉 mel
        raw_mel = whisper.log_mel_spectrogram(raw_audio, n_mels=n_mels) 

        asr_target = self.tokenizer.encode(" " + text)
        ...
        return {
            ...
            "ne_set": ne_set,
            "sentence": text,
            "raw_audio_length": raw_mel.size(1),
...
class WhisperTextModule(LightningModule):
    def __init__(self, cfg, model_name, lang) -> None:
        ...
        self.model = whisper.load_model(model_name,
                                        ...
                                        add_context_att = cfg.model_conf["add_context_att"],
                                        add_null_context = cfg.model_conf["add_null_context"],
                                        concoder_cofig = cfg.model_conf["concoder_cofig"],
                                        decoder_conf = cfg.decoder_conf,
                                        )
    ...
    def train_dataloader(self):
        ...
        return torch.utils.data.DataLoader(dataset,
                          ...
                          collate_fn=copyne_collate_fn(self.tokenizer))
